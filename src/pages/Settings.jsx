    ...
    <main className="rdb-container-narrow">
      <form className="rdb-panel space-y-5 p-5" onSubmit={saveProfile}>
        ...
        <div className="grid gap-4 sm:grid-cols-[110px_1fr]">
          {profile.avatar_url ? <img className="h-24 w-24 rounded-lg border border-rdb-border object-cover" src={profile.avatar_url} alt="" /> : <div className="h-24 w-24 rounded-lg border border-rdb-border bg-rdb-bg" />}
          <div>
